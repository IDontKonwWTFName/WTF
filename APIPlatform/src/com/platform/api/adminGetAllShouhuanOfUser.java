...
@WebServlet("/admimGetRelationByUser")
public class adminGetAllShouhuanOfUser extends HttpServlet{
	@Override
	...
	try {
		SQLQuery sqlQuery =session.createSQLQuery("select * from dbo.[Relation] where user_id=" + user_id).addEntity(Relation.class);
