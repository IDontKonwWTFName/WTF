...
@WebServlet("/admimGetLatestShouhuanLog")
public class getLatestShouhuanLog extends HttpServlet {
	...
	try {
		SQLQuery sqlQuery =session.createSQLQuery("select top 500 * from dbo.[Shouhuan_log] where shouhuan_id='" + shouhuan_id + "' order by time asc").addEntity(Shouhuan_log.class);
